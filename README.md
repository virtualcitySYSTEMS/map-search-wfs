...
| `displayNameTemplate`    | string                                                                                                                           | optional | A template for the display name of the search result. Is passed an object with the feature attributes. If not provided, the display name is generated from the address mapping.                           |
| `featureInfoViewOptions` | FeatureInfoViewOptions                                                                                                           | optional | Options for the feature info view. If not provided, the feature info view is generated from the address mapping.                                                                                          |
